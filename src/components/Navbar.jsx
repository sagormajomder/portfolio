...
const Navbar = () => {
    ...
    return (
        <motion.header
            ...
            className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-b-gray-200 dark:border-b-[#283339] bg-background-light/95 dark:bg-[#111618]/95 backdrop-blur-sm px-4 md:px-10 py-3"
        >
            ...
            {/* Mobile Menu Icon */}
            <div className="md:hidden text-gray-900 dark:text-white" onClick={() => setIsOpen(!isOpen)}>
